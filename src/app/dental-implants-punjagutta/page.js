...
export const metadata = {
  title:
    "Dental Implants in Punjagutta, Hyderabad | Best Implant Dentist | Dr. Bhuvan",
  description:
    "Looking for the best dental implants in Punjagutta, Hyderabad? Get advanced implant treatment by Dr. Bhuvanesh Yanamala, MDS Periodontist & Implantologist. Book your consultation today.",
};
