...
sameAs: [
  ...
  hasMap: "https://maps.app.goo.gl/Fiow6zV9W17xnxR47",
...
export const organizationSchema = {
  ...
  "@id": "https://www.drbhuvandentalcare.com/#organization",
...
export const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Who is the best dentist in Ameerpet?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Dr. Bhuvan's Dental Laser & Implant Centre provides comprehensive dental care including dental implants, laser dentistry, gum treatment, root canal treatment, teeth cleaning and cosmetic dentistry using modern technology and personalized care.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. We provide single tooth implants, multiple implants and full mouth dental implant solutions with personalized treatment planning.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Laser dentistry is minimally invasive for many procedures and may reduce bleeding, swelling and recovery time depending on the treatment.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We recommend booking an appointment in advance so we can provide dedicated consultation time and minimize waiting.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Dr. Bhuvan's Dental Laser & Implant Centre is located in Ameerpet, Hyderabad and serves patients from Yousufguda, SR Nagar, Punjagutta, Madhura Nagar, Srinagar Colony and nearby areas.",
      },
    },
  ],
};
