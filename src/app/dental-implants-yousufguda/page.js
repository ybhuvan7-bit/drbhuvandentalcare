...
export const metadata = {
  title:
    "Dental Implants in Yousufguda, Hyderabad | Best Implant Dentist | Dr. Bhuvan",
  description:
    "Looking for the best dental implants in Yousufguda, Hyderabad? Get advanced implant treatment by Dr. Bhuvanesh Yanamala, MDS Periodontist & Implantologist. Book your consultation today.",
};
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-blue-700 to-sky-500 text-white">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-20 lg:grid-cols-2">
          ...
          <div className="relative">
            ...
            <Image
              src="/implant.webp"
              alt="Dental Implants in Yousufguda Hyderabad"
              width={700}
              height={700}
              priority
...
<Link
href="/gum-disease-treatment-yousufguda"
